    ...
    try:
        ...
        with sync_playwright() as pw:
            ...
            try:
                ...
                assert summer['humidMontaneAssets']['treeFernSilhouette']['height']>=.58 and summer['humidMontaneAssets']['treeFernSilhouette']['height']<=.65 and summer['humidMontaneAssets']['treeFernSilhouette']['diameterX']>=1.05 and summer['humidMontaneAssets']['treeFernSilhouette']['diameterX']<=1.12 and summer['humidMontaneAssets']['treeFernSilhouette']['diameterZ']>=1.05 and summer['humidMontaneAssets']['treeFernSilhouette']['diameterZ']<=1.12 and summer['humidMontaneAssets']['treeFernSilhouette']['fronds']==20 and summer['humidMontaneAssets']['treeFernSilhouette']['segments']==9 and summer['humidMontaneAssets']['treeFernSilhouette']['pinnae']==320 and summer['humidMontaneAssets']['visualScales']==[[.88,.86,.88],[1.10,1.18,1.10],[.56,.56,.56],[.80,.78,.80]]
