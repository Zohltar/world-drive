    ...
    try:
        ...
        with sync_playwright() as pw:
            ...
            try:
                ...
                assert summer['tropicalDensity']['baseCandidatesPerCell']==109 and summer['tropicalDensity']['denseCandidatesPerCell']==150 and summer['tropicalDensity']['qualifiedChunks']>=2
