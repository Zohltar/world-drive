...
for(const preset of presets){
  ...
  // Deterministic mountainous synthetic DEM lets us exercise the complete ACTIVE
  // road builder against real routed X/Z geometry without depending on Terrarium.
