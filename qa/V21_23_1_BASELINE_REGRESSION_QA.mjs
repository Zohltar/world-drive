...
assert.equal(pkg.version,'21.23.1');
assert.ok(main.includes("version:'21.23.1-candidate'"));

// V21.22.6 terrain/satellite + core dynamics/presentation stay byte-for-byte.
const unchanged={
...
console.log('V21.23.1 BASELINE REGRESSION QA: PASS');
