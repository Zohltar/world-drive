...
const worldMaterialsFacade=read('src/world-materials.js');
const worldMaterials=read('src/terrain/world-materials.js');
...
has(worldMaterialsFacade,"from './terrain/world-materials.js'",'stable world-materials facade changed');
