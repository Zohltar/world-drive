...
// Issue #12 keeps forest streaming interest tied to the continuously moving
// vehicle while floating worldOffset remains a render-origin concern only.
...
await import('./qa-issue12-forest-observer-center-r5.mjs');
