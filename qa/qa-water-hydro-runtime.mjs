...
const overpass={
  async fetchRaw(){
    fetches++;
    return {elements:[
      {type:'way',id:101,tags:{waterway:'river'},geometry:[{lat:45,lon:-73},{lat:45.001,lon:-72.999}]},
      {type:'way',id:202,tags:{highway:'secondary',bridge:'yes'},geometry:[{lat:45.002,lon:-73.002},{lat:45.003,lon:-73.001}]}
    ]};
  },
...
console.log('WATER / HYDRO RUNTIME QA: PASS',{
  visibleLoad:true,
