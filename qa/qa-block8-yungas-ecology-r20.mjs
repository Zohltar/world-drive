...
check('humid montane assets expose Yungas broadleaf epiphyte tree-fern and bamboo cues with one material',()=>{
  const d=style.diagnostics();assert.equal(d.id,R20_PRESENTATION);assert.deepEqual(d.models,[...R20_MODELS]);assert.deepEqual(d.triangles,[324,380,1052,96]);
