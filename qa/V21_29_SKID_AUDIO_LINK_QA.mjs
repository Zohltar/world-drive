...
const near=skidLinkedTireLevel({tireSquealLevel:.55,wheelGripUsage:[.93,.93,.93,.93]});
...
if(!(near>quiet&&near<light))fail(`Pre-skid cue must sit between silence and visible skid: ${near}`);
...
console.log('V21.29 skid/audio linkage QA passed',{quiet,near,light,dark});
