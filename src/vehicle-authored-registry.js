...
const DESCRIPTORS=Object.freeze({
  id4:Object.freeze({
    id:'id4',label:'ID.4',kind:'passenger',exportName:'createId4GlbSystem',
    capabilities:Object.freeze(['body','materials','wheels','steering','brake','reverse','night']),
    loadModule:()=>import('./id4-glb.js')
  }),
  wrx:Object.freeze({
    id:'wrx',label:'WRX',kind:'passenger',exportName:'createWrxGlbSystem',
    capabilities:Object.freeze(['body','materials','wheels','steering','brake','reverse','night']),
    loadModule:()=>import('./wrx-glb.js')
  }),
  civic:Object.freeze({
    id:'civic',label:'Civic',kind:'passenger',exportName:'createCivicGlbSystem',
    capabilities:Object.freeze(['body','materials','wheels','steering','brake','reverse','night']),
    loadModule:()=>import('./civic-glb.js')
  }),
  sonata:Object.freeze({
    id:'sonata',label:'Sonata',kind:'passenger',exportName:'createSonataGlbSystem',
  ...
  f1_2010:Object.freeze({
    id:'f1_2010',label:'F1',kind:'passenger',exportName:'createF1GlbSystem',
  ...
  countach_80:Object.freeze({
    id:'countach_80',label:'Countach',kind:'passenger',exportName:'createCountachGlbSystem',
  ...
  i3_2017:Object.freeze({
    id:'i3_2017',label:'BMW i3',kind:'passenger',exportName:'createI3GlbSystem',
    capabilities:Object.freeze(['body','materials','wheels','steering','brake','reverse','night']),
    loadModule:()=>import('./i3-glb.js')
  }),
  semi_6x4:Object.freeze({
    id:'semi_6x4',label:'Semi 6x4',kind:'articulated-truck',exportName:'createTruckTrailerSystem',
...
export function getAuthoredVehicleDescriptor(vehicleId){
  return DESCRIPTORS[vehicleId]||null;
}

export function listAuthoredVehicleDescriptors(){
  return Object.values(DESCRIPTORS);
}

export function listAuthoredVehicleIds(){
