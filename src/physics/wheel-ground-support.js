export function createWheelGroundSupport({
  ...
  // Issue #4: a bridge/viaduct can be several metres above the DEM. Outside the
  // physical shoulder, blending that detached road plane down toward terrain
  // creates an invisible support ramp beside and underneath the bridge. Keep
  // ordinary embankment blending intact, but reject clearly detached elevated
  // road support once a wheel has left the solid road core.
