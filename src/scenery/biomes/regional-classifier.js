/**
 * Maintained regional atlas query, promoted from the tested Block 8 R1 prototype.
...
export {BIOME_PROFILES} from './biome-profiles.js';
...
export function createBiomeClassifier(atlas = null, { cacheLimit = 256, blendMeters = 500 } = {}) {
  ...
  const profileBiome = record => biomeIdForRecord(record, source?.id);
