...
const LIGHTING_CONTRACTS=Object.freeze({
  wrx:Object.freeze({
    ...
    reversePaths:['fh_taillight_no_brake_new_material'],
    headlightPaths:['fh_lowhighbeam_material','fh_headlight_part4_material'],
    leftSignalPaths:['fh_front_indicator_orange_l','fh_signal_l_black'],
    rightSignalPaths:['fh_front_indicator_orange_r','fh_signal_r_black']
  }),
  civic:Object.freeze({
    strategy:'civic',
    requiredFamilies:['brake','reverse','night','signal-left','signal-right'],
  ...
  i3_2017:Object.freeze({
    strategy:'i3_2017',
    requiredFamilies:['brake','reverse','night'],
    materials:['carro_refletor_farol','carro_refletor_farol_1','carro_vidros_vermelhos','carro_vidros_vermelhos_1','carro_refletor_lanterna']
  }),
  ...
  id4:Object.freeze({
    strategy:'id4',
    requiredFamilies:['brake','reverse','night'],
    exactNodes:['13_headlight_glass_glass_0','16_headlight_white_plastic_white_P_0','52_trunk_tilllight_glass_glass_0'],
...
const PRESENTATION_OVERRIDES=Object.freeze({
  id4:Object.freeze({
    ...
    hdAsset:'id4_2021_detailed.glb',hdUrl:new URL('./assets/id4_2021_detailed.glb',import.meta.url).href,hdLengthScale:1,
    lighting:'id4'
  }),
  wrx:Object.freeze({
    color:0x2766a5,wheelRadius:.35,bodyHeight:.48,
    hdAsset:'subaru_wrx_vb.glb',hdUrl:new URL('./assets/subaru_wrx_vb.glb',import.meta.url).href,hdLengthScale:1.20,
    lighting:'wrx'
  }),
  civic:Object.freeze({
    color:0x101317,wheelRadius:.34,bodyHeight:.47,
    hdAsset:'2006_honda_civic_si.glb',hdUrl:new URL('./assets/2006_honda_civic_si.glb',import.meta.url).href,hdLengthScale:1,
    lighting:'civic'
  }),
  sonata:Object.freeze({
    color:0xe9edf0,wheelRadius:.35,bodyHeight:.48,
    hdAsset:'2006_hyundai_sonata.glb',hdUrl:new URL('./assets/2006_hyundai_sonata.glb',import.meta.url).href,hdLengthScale:1,
    lighting:'sonata'
  }),
  i3_2017:Object.freeze({
    color:0xf0f1ee,wheelRadius:.35,bodyHeight:.70,
    hdAsset:'2017_bmw_i3.glb',hdUrl:new URL('./assets/2017_bmw_i3.glb',import.meta.url).href,hdLengthScale:1.20,
    lighting:'i3_2017'
  }),
  f1_2010:Object.freeze({
    color:0xc51f27,wheelRadius:.32,bodyHeight:.24,
    hdAsset:'f1_2010_ferrari.glb',hdUrl:new URL('./assets/f1_2010_ferrari.glb',import.meta.url).href,hdLengthScale:1,
    lighting:'f1_2010'
  }),
  countach_80:Object.freeze({
    color:0xd42222,wheelRadius:.34,bodyHeight:.34,
    hdAsset:'countach_80.glb',hdUrl:new URL('./assets/countach_80.glb',import.meta.url).href,hdLengthScale:1.15,hdTargetWidth:2.08*1.15,
    lighting:'countach_80'
  }),
  semi_6x4:Object.freeze({
    color:0xb52b28,wheelRadius:.52,bodyHeight:2.65,
    hdAsset:null,hdUrl:null,hdLengthScale:1,
    lighting:'fallback'
  })
});
...
function buildSpec(vehicleId){
  ...
  return Object.freeze({
    ...
    physics:Object.freeze({
      wheelbase:Number(physics.wheelbase),trackWidth:Number(physics.trackWidth),bodyLength,bodyWidth,
      axles:Object.freeze((physics.axles||[]).map(axle=>Object.freeze({...axle})))
    }),
    visual:Object.freeze({
      color:override.color,bodyHeight:override.bodyHeight,wheelRadius,
      rideHeight:Number(profile.visual?.rideHeight)||wheelRadius,
      supportContacts:supportContactsFromAxles(physics,wheelRadius)
    }),
    hd:Object.freeze({
      enabled:!!override.hdUrl,asset:override.hdAsset,url:override.hdUrl,
      targetLength:override.hdUrl?bodyLength*Math.max(.5,Number(override.hdLengthScale)||1):null,
...
export function multiplayerRegistryDiagnostics(){
  return listMultiplayerVehicleSpecs().map(spec=>({
    id:spec.id,vehicleClass:spec.vehicleClass,wheelbase:spec.physics.wheelbase,trackWidth:spec.physics.trackWidth,
    axles:spec.physics.axles.length,supportContacts:spec.visual.supportContacts.length,hd:spec.hd.enabled,lighting:spec.lighting.strategy
  }));
}
