...
for(const internal of ['streamedWorldGroups']){
  if(outside.includes(internal))throw new Error(`C5.3 internal world-scene binding used outside extraction block: ${internal}`);
}
for(const publicName of [
  'terrainDetailGroup','waterGroup','infrastructureGroup','signGroup','sceneryInfrastructureGroup',
  'buildingGroup','roadGroup','forestGroup','sceneryForestGroup','horizonGroup','groundMat','ground',
  'resetStreamedWorldOrigins','freezeStaticMatrices','resetStaticGroupOrigin','NEAR_TERRAIN_SIZE','NEAR_TERRAIN_SEGMENTS'
]){
